...
module.exports.run = async function({ api, event, Users, Threads }) {
  ...
  const type = (event.author == event.logMessageData.leftParticipantFbId) ? "  তোর সাহস কম নয় এখানে 𝐓𝐀𝐑𝐄𝐊 𝐁𝐎𝐓___//𝟎𝟎𝟕 থাকতে তুই left নেছ😡😠🤬 \n✢━━━━━━━━━━━━━━━✢\n ----❖----- 𝐓𝐀𝐑𝐄𝐊 -----❖----" : "তোমার এই গ্রুপে থাকার কোনো যোগ্যাতা নেই আবাল😡।\nতাই তোমার লাথি মেরে গ্রুপ থেকে বের করে দেওয়া হলো🤪। WELLCOME REMOVE🤧 \n✢━━━━━━━━━━━━━━━✢\n ----❖----- 𝐓𝐀𝐑𝐄𝐊 -----❖----";
